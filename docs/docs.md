...
CREATE TABLE events (
	...
	reminder_interval int,  	-- The reminder interval.
	reminder_unit varchar(128), -- The reminder unit to identify the reminder interval in minutes, hours, or days.
    reminder_day_Mo boolean, 	-- The reminder days (single): Monday
    reminder_day_Tu boolean, 	-- The reminder days (single): Tuesday
    reminder_day_We boolean, 	-- The reminder days (single): Wednesday
    reminder_day_Th boolean, 	-- The reminder days (single): Thursday
    reminder_day_Fr boolean, 	-- The reminder days (single): Friday
    reminder_day_Sa boolean, 	-- The reminder days (single): Saturday
    reminder_day_Su boolean, 	-- The reminder days (single): Sunday
	created_at timestamptz, 	-- It stores the date and time at which the event is created.
    ...
    end_type varchar(128),		-- None, date, after n occurences
    ends_at timestamptz,
