...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("resource", sa.VARCHAR(length=512), autoincrement=False, nullable=True),
        sa.Column("resource_uuid", postgresql.UUID(as_uuid=True), autoincrement=False, nullable=True),
        sa.Column("thread_resource", sa.VARCHAR(length=512), autoincrement=False, nullable=True),
        sa.Column("thread_uuid", postgresql.UUID(as_uuid=True), autoincrement=False, nullable=True),
