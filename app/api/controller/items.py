...
from app.schemas.responses import ItemResponse, ItemsPaginated, StandardResponse
...
@item_test_router.patch("/{item_uuid}", status_code=HTTP_204_NO_CONTENT)  # response_model=ItemIndexResponse
def item_edit(item_service: itemServiceDependency, item_uuid: UUID, item_data: ItemEditIn, auth_user: CurrentUser):
    item_service.edit_item(item_uuid, item_data)
    return None
