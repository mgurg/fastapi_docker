...
def open_new_basic_summary(db: Session, resource: str, resource_uuid: UUID, action: str):
    event_statistic = {
        "uuid": str(uuid4()),
        "resource": resource,
        "resource_uuid": resource_uuid,
...
def close_new_basic_summary(db: Session, resource: str, resource_uuid: UUID, previous_event: str):
    event = crud_events.get_event_summary_by_resource_uuid_and_status(db, resource, resource_uuid, previous_event)
