...
#     fields = [Users.id, Users.user_role_id, Users.client_id]
...
# ) -> List[int]:
#     """Returns (for authenticated User): user_id, user_role_id, client_id"""
#     token = credentials.credentials
#     if token is None:
#         raise HTTPException(status_code=401, detail="Missing auth token")
...
#     user_id, user_role_id, client_id = user_data
#     return [user_id, user_role_id, client_id]
