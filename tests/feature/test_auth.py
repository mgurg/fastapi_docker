...
def test_first_run(publicClient: TestClient):
    ...
    headers = {"tenant": "public", "Content-Type": "application/json"}
    response = publicClient.post("/auth/first_run", data=json.dumps(data), headers=headers)
    data = response.json()
...
def test_login(publicClient: TestClient):
    ...
    headers = {"tenant": "public", "Content-Type": "application/json"}
    response = publicClient.post("/auth/login", data=json.dumps(data), headers=headers)
    data = response.json()
