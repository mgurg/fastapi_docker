...
from app.db import get_session, get_db, get_public_db
...
def client_fixture(db_fixture: Session,public_db_fixture: Session, session_fixture: Session):
    ...
    def get_public_db_override():
        return public_db_fixture
    ...
    app.dependency_overrides[get_public_db] = get_public_db_override
